...
numpy|BSD 3-Clause|2025 NumPy Developers|
sklearn|BSD 3-Clause|2025 Scikit-learn Developers|
tensorflow|Apache 2.0|2025 TensorFlow Authors|

## 포함된 폰트
이름|라이센스|저작권|
|---|---|---|
NanumGothic|SIL Open Font License|2008 NAVER Corporation|
